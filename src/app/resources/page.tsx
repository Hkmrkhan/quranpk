...
const downloadableResources: ResourceItem[] = [
  ...
  },
  {
    ...
    format: "PDF Document",
    description:
      "High-resolution chart showing letter forms (isolated, initial, medial, final) and heavy vs light letter distinctions.",
  },
  {
  ...
  {
    title: "Prophetic Morning & Evening Athkar Booklet",
    category: "Spiritual",
    fileSize: "4.0 MB",
    format: "E-Book",
    description:
      "Authentic daily remembrance collection with full Arabic text, transliteration, and English translation.",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {downloadableResources.map((res, idx) => (
            <ScrollReveal key={idx} direction="up" delay={idx * 0.1}>
              <div className="bg-cream-50 rounded-2xl p-8 border border-sage-200/80 shadow-xs hover:shadow-md transition-all flex flex-col justify-between">
                <div>
                ...
                <div className="pt-4 border-t border-sage-200/60 flex items-center justify-between">
                  ...
                  <button
                    onClick={() => {
                      alert(`Downloading sample resource: ${res.title}`);
                    }}
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sage-700 text-cream-50 text-xs font-semibold hover:bg-sage-800 transition-colors shadow-xs"
                  >
